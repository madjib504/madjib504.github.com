...
const WellnessPacks = () => {
  ...
  return (
    <div data-testid="wellness-packs-page" className="min-h-screen bg-gradient-to-br from-stone-50 via-green-50 to-purple-50 pt-24 px-6 pb-12">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            <Package className="w-12 h-12 text-green-900" />
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-green-900" data-testid="packs-title">
              Packs Bien-être
            </h1>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-green-800 bg-green-50 rounded-full px-6 py-2 inline-flex">
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <Button
                  ...
                  className="w-full bg-green-900 text-white hover:bg-green-800 rounded-full py-6 text-lg font-medium shadow-lg"
